...
public abstract class ResponseMessage {
     ...
     */
    public static final String CONTACT_MESSAGE_SAVE_RESPONSE = "Messages Successfully Created";
    public static final String CONTACT_MESSAGE_DELETE_RESPONSE = "Messages Successfully Deleted";
    public static final String CONTACT_MESSAGE_UPDATE_RESPONSE = "Messages Successfully Updated";
